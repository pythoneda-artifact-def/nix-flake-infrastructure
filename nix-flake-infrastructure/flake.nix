  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.2";
        sha256 = "sha256-SqrgWT5ApUq8AikNxiZsfjOsnQ+ONkyvt7Q0sO7xlNg=";
        pname = "${org}-${repo}";
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pythoneda-artifact-nix-flake-infrastructure-raw-python38 =
          ...
          pythoneda-artifact-nix-flake-infrastructure-raw-python39 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-artifact-nix-flake-infrastructure-python39;
              python = pkgs.python39;
          ...
          pythoneda-artifact-nix-flake-infrastructure-raw-python310 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-artifact-nix-flake-infrastructure-python310;
              python = pkgs.python310;
          ...
          pythoneda-artifact-nix-flake-infrastructure-raw-python311 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-artifact-nix-flake-infrastructure-python311;
              python = pkgs.python311;
