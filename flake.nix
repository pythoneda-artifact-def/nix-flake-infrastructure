        ...
        pythoneda-artifact-nix-flake-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-artifact-nix-flake} ${pythoneda-shared-artifact-code-events} ${pythoneda-shared-artifact-code-events-infrastructure} ${pythoneda-shared-artifact-events} ${pythoneda-shared-artifact-events-infrastructure} ${pythoneda-shared-code-requests-jupyterlab} ${pythoneda-shared-code-requests-shared} ${pythoneda-shared-nix-flake-shared} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
              ...
              for nixpkgsDep in ${dbus-next} ${joblib} ${requests}; do
